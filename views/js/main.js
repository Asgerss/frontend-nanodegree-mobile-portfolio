...
/* The resizePizza function have been reworked. Now the new pizza size is based on % rather than calculating a px width.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  for (var i = 0; i < window.innerHeight/30; i++) {
